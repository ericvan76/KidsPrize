        ...
        try {
          ...
          if (existing) {
            if (existing.score !== score) {
              // update task's score
              module.exports.DayScore.update({
                _id: dayScore._id,
                __v: dayScore.__v,
                'scores.task': task
              }, {
                ...
                if (err) {
                  ...
                  module.exports.DayScore.findById(dayScore._id, callback);
                }
              });
            } else {
...
// exports
module.exports.DayScore = mongoose.model('DayScore', DayScoreSchema);
