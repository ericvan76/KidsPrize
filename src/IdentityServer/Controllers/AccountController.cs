...
namespace IdentityServer.Controllers
{
    ...
    {
        private readonly IdentityServer.Services.IUserLoginService _loginService;
        private readonly IIdentityServerInteractionService _interaction;

        public AccountController(
            IdentityServer.Services.IUserLoginService loginService,
        ...
        public async Task<IActionResult> ExternalCallback(string returnUrl)
        {
            ...
            var cp = new ClaimsPrincipal(
                new ClaimsIdentity(additionalClaims, "external", JwtClaimTypes.Name, JwtClaimTypes.Role));
