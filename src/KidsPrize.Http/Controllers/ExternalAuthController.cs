...
namespace KidsPrize.Http.Controllers
{
    ...
    public class ExternalAuthController : Controller
    {
        ...
        public ExternalAuthController(IUserService userService, SignInInteraction signInInteraction, IMessageStore<ConsentResponse> consentResponseStore)
        {
        ...
        public async Task<IActionResult> Callback([FromQuery] ExternalAuthRequest authReq)
        {
            ...
            var user = await this._userService.CreateOrUpdateUser(claimPrincipal.CreateUser());
